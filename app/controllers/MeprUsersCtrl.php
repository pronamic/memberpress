...
class MeprUsersCtrl extends MeprBaseCtrl {
  ...
  public static function enqueue_scripts($hook) {
    ...
    if($hook == 'user-edit.php' || $hook == 'profile.php') {
      ...
      wp_enqueue_script('mp-edit-user', MEPR_JS_URL.'/admin_profile.js', array('jquery', 'suggest', 'mp-i18n'), MEPR_VERSION);
    }
  }
  ...
  public static function maybe_redirect_member_from_admin() {
    ...
    if(strpos($_SERVER['REQUEST_URI'], 'admin-post.php') !== false && isset($_REQUEST['action'])) { return; }
