  ...
  */
  ...
  public static function enqueue_scripts($hook) {
    ...
    if($current_screen->post_type == MeprRule::$cpt) {
      ...
      wp_enqueue_script('mepr-rules-js', MEPR_JS_URL.'/admin_rules.js', array('jquery','jquery-ui-autocomplete','mepr-date-picker-js','rule-form-validator'), MEPR_VERSION, true);
