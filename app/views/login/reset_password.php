...
<div class="mp_wrapper">
  <h3><?php echo esc_html_x('Enter your new password', 'ui', 'memberpress'); ?></h3>
  <form name="mepr_reset_password_form" id="mepr_reset_password_form" class="mepr-form" action="" method="post">
    ...
    <div class="mp-form-row mepr_password">
      <div class="mp-form-label">
        <label for="mepr_user_password"><?php echo esc_html_x('Password', 'ui', 'memberpress'); ?>:</label>
    ...
    <div class="mp-form-row mepr_password_confirm">
      <div class="mp-form-label">
        <label for="mepr_user_password_confirm"><?php echo esc_html_x('Password Confirmation', 'ui', 'memberpress'); ?>:</label>
        <div class="mp-hide-pw">
    ...
    <?php MeprHooks::do_action('mepr_reset_password_after_password_fields'); ?>

    <div class="mepr_spacer">&nbsp;</div>
    <div class="submit">
      <input type="submit" name="wp-submit" id="wp-submit" class="button-primary mepr-share-button " value="<?php echo esc_attr_x('Update Password', 'ui', 'memberpress'); ?>" tabindex="720" />
