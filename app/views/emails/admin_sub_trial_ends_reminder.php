...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
   <div id="receipt">
      <div class="section" style="display: block; margin-bottom: 24px;"><strong>{$username}'s</strong> Trial Period for {$product_name} will end on <strong>{$subscr_trial_end_date}</strong>.</div>
