...
<div id="header" style="width: 680px; padding: 0px; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php echo esc_html_x('New Recurring Subscription', 'ui', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php echo esc_html_x('A subscription was just created on {$blog_name}:', 'ui', 'memberpress'); ?></div>
  <table style="clear: both;" class="transaction">
    ...
    <tr><th style="text-align: left;"><?php echo esc_html_x('Auto-Rebilling:', 'ui', 'memberpress'); ?></th><td><?php echo esc_html_x('Enabled', 'ui', 'memberpress'); ?></td></tr>
