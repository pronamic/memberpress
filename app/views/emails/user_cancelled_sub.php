...
<div id="header" style="width: 680px; padding: 0px; margin: 0 auto; text-align: left;">
  <h1 style="font-size: 30px; margin-bottom: 0;"><?php echo esc_html_x('Your Automatic Payments Have Been Stopped', 'ui', 'memberpress'); ?></h1>
...
<div id="body" style="width: 600px; background: white; padding: 40px; margin: 0 auto; text-align: left;">
  <div class="section" style="display: block; margin-bottom: 24px;"><?php echo esc_html_x('Your subscription on {$blog_name} was cancelled:', 'ui', 'memberpress'); ?></div>
  <table style="clear: both;" class="transaction">
    ...
    <tr><th style="text-align: left;"><?php echo esc_html_x('Status:', 'ui', 'memberpress'); ?></th><td><?php echo esc_html_x('Stopped', 'ui', 'memberpress'); ?></td></tr>
