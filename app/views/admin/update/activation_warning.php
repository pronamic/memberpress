...
<?php else : ?>
  ...
  ?>
  <div class="error drm-mepr-activation-warning" style="padding: 10px;"><?php printf(__('<b>MemberPress doesn\'t have a valid license key installed.</b> Go to the MemberPress %1$ssettings page%2$s to activate your license or go to %3$smemberpress.com%4$s to get one.', 'memberpress'), '<a href="' . esc_url($settings_page_url) . '">', '</a>', '<a href="https://www.memberpress.com">', '</a>'); ?></div>
<?php endif; ?>
