...
<h2 class="nav-tab-wrapper">
  <a class="nav-tab main-nav-tab nav-tab-active" href="#" id="registration">
    <?php esc_html_e('Registration', 'memberpress'); ?>
  </a>
  <a class="nav-tab main-nav-tab" href="#" id="who-can-purchase"><?php esc_html_e('Permissions', 'memberpress'); ?></a>
  <?php if (!empty($product->group_id)) : ?>
  ...
  <?php if (MeprHooks::apply_filters('mepr_display_order_bumps_upsell', false)) : ?>
    <a class="nav-tab main-nav-tab" href="#" id="order-bumps-upsell">
        <?php esc_html_e('Order Bumps', 'memberpress'); ?>
    </a>
  <?php endif; ?>
